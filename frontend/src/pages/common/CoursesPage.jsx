...
const sampleCourses = [
  ...
  {
    id: 2,
    title: "The Data Science Course 2024: Complete",
    author: "365 Careers",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCgUNTvP0H0wr2P2S95XxoCJhQz6RkKCpeEVS2fND9GWhTLjqwGEY7golIkrdXAuDpqrUJZhpYvSNClHVbAb9v2gufhYiVQPXzjwANGtXY25WWhHMpbQ-TLdgFabJ3zJhAk_Sg1vOoXfLIBpvIm3oxasS27L0KUBAN_FiLgNXmqGvh9pJ9LHiOR3k1aC_mPYWG-2Am3GBdvTpzJfU02zygPDsMmsM2p7s6vcoseyl5qvBB0r2MLRx_m74A1s28HFoR1R3W9bhtRhwU",
    rating: 4.7,
    reviews: "9,876",
  },
  {
  ...
  },
  {
    ...
    author: "Rob Percival",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuApNfmsHDAgY_yWNnafna7caCHaT-SdlppC_fXg6yqVMuC9K6H-T9W2hX4kd6erbj5epl17vU3AU45nWBZTqTOvFrQJm3DAZiDJcLYcORWnNYZkSoMeFBmDpoWt_fbNVonhmADzTJvDM8IaWUt17XphIMPANNoKZWgsHjfXy0nCuzLlcMOXdc-Mo95Cz-xmjUVXQpiAgIOCpc_3WD4xUALFH14Y3BUwCCD9dsAE5DXGnkTwzmTf5PDtgU4O1TsLn34zK4wa-gWadx0",
    rating: 4.6,
    reviews: "21,500",
  },
  {
            ...
            <div className="w-full lg:w-3/4 xl:w-4/5">
              <div className="flex flex-col sm:flex-row justify-between items-baseline mb-6 gap-4">
                <h2 className="text-gray-900 dark:text-white text-xl font-bold leading-tight tracking-[-0.015em]">
                  Hiển thị {sampleCourses.length} kết quả:
                </h2>
              ...
              <div className="flex justify-center mt-10">
                ...
                >
                  ...
                  <button className="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-primary text-white font-bold">
                    1
                  </button>
                  <button className="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-medium hover:bg-gray-100 dark:hover:bg-gray-700">
                    2
                  </button>
                  <span className="inline-flex items-center justify-center h-9 w-9 text-gray-500">
                    ...
                  </span>
                  <button className="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-medium hover:bg-gray-100 dark:hover:bg-gray-700">
                    10
